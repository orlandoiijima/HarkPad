...
- (void)invalidateLayoutIfNecessary {
    ...
    if ([self.collectionView.delegate conformsToProtocol:@protocol(LXReorderableCollectionViewDelegateFlowLayout)]) {
        ...
        if ([theDelegate collectionView:self.collectionView layout:self itemAtIndexPath:self.selectedItemIndexPath canMoveToIndexPath:theIndexPathOfSelectedItem] == NO)
            return;
    }
...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)theLongPressGestureRecognizer {
    switch (theLongPressGestureRecognizer.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            if ([self.collectionView.delegate conformsToProtocol:@protocol(LXReorderableCollectionViewDelegateFlowLayout)]) {
                id<LXReorderableCollectionViewDelegateFlowLayout> theDelegate = (id<LXReorderableCollectionViewDelegateFlowLayout>)self.collectionView.delegate;
                [theDelegate collectionView:self.collectionView layout:self didStartDragAtIndexPath:theIndexPathOfSelectedItem];
            }
        ...
        case UIGestureRecognizerStateEnded: {
            ...
            [UIView
             ...
             completion:^(BOOL finished) {
                 ...
                 if ([self.collectionView.delegate conformsToProtocol:@protocol(LXReorderableCollectionViewDelegateFlowLayout)]) {
                     id<LXReorderableCollectionViewDelegateFlowLayout> theDelegate = (id<LXReorderableCollectionViewDelegateFlowLayout>)self.collectionView.delegate;
                     [theDelegate collectionView:self.collectionView layout:self didDropAtIndexPath:theIndexPathOfSelectedItem];
                 }
