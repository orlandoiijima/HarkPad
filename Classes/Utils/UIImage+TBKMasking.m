...
-(UIImage *) tabBarImage {
	return ([self imageMaskedWithColors:[NSArray arrayWithObjects:[UIColor colorWithHue:(0.0/360.0) saturation:(0.0/100.0) brightness:(42.0/100.0) alpha:(1.0/1.0)], [UIColor colorWithHue:(0.0/360.0) saturation:(0.0/100.0) brightness:(27.0/100.0) alpha:(1.0/1.0)], nil]
								opacity:0.0]);
}
		...
		UIGraphicsBeginImageContextWithOptions([self size], NO, 0.0);
		{
			...
			CGContextSaveGState(context);
			{
				...
				CGContextSaveGState(context);
				{
					...
					CGGradientRef gradient = CGGradientCreateWithColors(space, (__bridge_retained CFArrayRef)ar, NULL);
